...
- Built a deployable API for real-time predictions
- Designed to support data-driven retention strategies
...
- Evaluated performance using Hit@K and MRR metrics
- Focused on efficiency, control, and system understanding
...
- Building more production-level AI systems
